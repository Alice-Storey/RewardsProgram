...
public class AccountServiceTest {
    ...
    public void testAddDeleteAccounts() {
        ...
        Account testAccount1 = new Account("jane.s");
        Account testAccount2 = new Account("john.c");
        ...
        assertEquals(acc.getRewardsPoints(), accGot.getRewardsPoints());
        ...
        assertEquals(acc2.getRewardsPoints(), accGot2.getRewardsPoints());
